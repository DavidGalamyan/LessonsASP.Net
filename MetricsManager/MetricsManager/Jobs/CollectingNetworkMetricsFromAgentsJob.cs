...
namespace MetricsManager.Jobs
{
    ...
    public class CollectingNetworkMetricsFromAgentsJob : IJob
    {
        ...
        private readonly IManagerNetworkMetricsRepository _repository;
        private readonly IMetricsAgentClient _metricsAgentClient;
        private readonly IMapper _mapper;
        public CollectingNetworkMetricsFromAgentsJob(IAgentInfoRepository agentRepository, IManagerNetworkMetricsRepository repository,
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            foreach (var agent in agentList)
            {
                ...
                {
                    var metricList = new List<NetworkMetric>();
                    foreach (var metric in response.Metrics)
                    {
                        var convertedMetric = _mapper.Map<NetworkMetric>(metric);
